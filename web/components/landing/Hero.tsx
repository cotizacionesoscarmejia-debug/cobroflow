...
import { CtaButton, Perforacion } from './ui';
        ...
        >
          ...
          <div className="mt-10 w-full max-w-[720px]">
            {visual ? (
              ...
              <div className="relative flex aspect-[4/3] w-full flex-col items-center justify-center gap-3 rounded-[var(--radius-card)] border-2 border-dashed border-[color-mix(in_oklab,var(--text-tertiary)_45%,transparent)] bg-[color-mix(in_oklab,var(--accent)_5%,transparent)] px-8">
                <Perforacion className="opacity-70" />
